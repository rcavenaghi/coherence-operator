...
func TestCreateStatefulSetFromRoleWithCoherenceManagementEmpty(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceManagementEnabledFalse(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceManagementEnabledTrue(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceManagementEnabledWithPort(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceManagementWithSSLEnabledWithoutSecret(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceManagementWithSSLEnabledWithSecret(t *testing.T) {
