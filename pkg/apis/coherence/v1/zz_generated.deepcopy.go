...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoggingConfigTemplate) DeepCopyInto(out *LoggingConfigTemplate) {
	*out = *in
	if in.Logging != nil {
		in, out := &in.Logging, &out.Logging
		*out = new(LoggingSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoggingConfigTemplate.
func (in *LoggingConfigTemplate) DeepCopy() *LoggingConfigTemplate {
	if in == nil {
		return nil
	}
	out := new(LoggingConfigTemplate)
	in.DeepCopyInto(out)
	return out
}
