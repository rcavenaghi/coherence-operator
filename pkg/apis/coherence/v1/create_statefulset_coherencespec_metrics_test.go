...
func TestCreateStatefulSetFromRoleWithCoherenceMetricsEmpty(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceMetricsEnabledFalse(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceMetricsEnabledTrue(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceMetricsEnabledWithPort(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceMetricsWithSSLEnabledWithoutSecret(t *testing.T) {
...
func TestCreateStatefulSetFromRoleWithCoherenceMetricsWithSSLEnabledWithSecret(t *testing.T) {
